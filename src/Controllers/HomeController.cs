...
namespace Deferat.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Contact()
        {
            ...
            return View(DefaultSettingsViewModelBase());
        }

        public IActionResult Privacy() => View(DefaultSettingsViewModelBase());

        private ViewModelBase DefaultSettingsViewModelBase()
        {
